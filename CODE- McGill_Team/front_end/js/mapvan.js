...
//create point layers
var van_hosplyr =  new L.geoJson(van_hosp, {
...
var van_greelyr =  new L.geoJson(van_gree, {    
  pointToLayer: function (feature, latlng) {
...
var van_scholyr =  new L.geoJson(van_scho, {
  pointToLayer: function (feature, latlng) {
...
var van_cultlyr =  new L.geoJson(van_cult, { 
  pointToLayer: function (feature, latlng) {
...
var van_groclyr =  new L.geoJson(van_groc, {        
  pointToLayer: function (feature, latlng) {
...
var van_gaslyr =  new L.geoJson(van_gas, {        
  pointToLayer: function (feature, latlng) {
...
var van_emerlyr =  new L.geoJson(van_emer, {        
  pointToLayer: function (feature, latlng) {
...
var hosp = L.layerGroup([van_hosplyr]);
var park = L.layerGroup([van_greelyr]);
var school = L.layerGroup([van_scholyr]);
var culture = L.layerGroup([van_cultlyr]);
var grocery = L.layerGroup([van_groclyr]);
var gas = L.layerGroup([van_gaslyr]);
var police = L.layerGroup([van_emerlyr]);
