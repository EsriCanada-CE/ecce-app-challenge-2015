...
## What is CODE?
Run Our Live Demo [HERE](http://code-engage.com)
...
----
## To Engage Usage
1a. Visit our user interface [here] (http://code-engage.com).
2. Alternatively, visit our GitHub repoistory [here](https://github.com/terratenney/ecce-app-challenge-2015/).
3. Clone repository
...
We access the spatial information through Esri Leaflets layer functionality using JavaScript.
...
Lack of descriptive information in popup balloons comes from unstandardized data formats. Would be very easy to implement properly. Also there are some features of CODE that we did not have time to fully implement. So we tried to 'demonstrate' these where possible. So if you find yourself asking "Why can't I make something other than age show up in the right corner?" - it is because we had a lot of data we wanted to share with you and making the individual controls was time consuming. But check back and it will eventually be done!
   

## Bug Reporting

You can send CODE bug reports to <matthew.tenney@mail.mcgill.ca>.
